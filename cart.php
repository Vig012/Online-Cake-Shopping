                    			...
                    			<div class="table-responsive">
                    				<table class="table table-bordered">
                    					...
                    					<tbody>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    Delivery Date:<input class="form-control" type="date" name="delivery_date" min="2022-08-25" max="2022-09-30" required="">
                                                </td>
                                                <td colspan="3">
                                                    <label>
                                                        <input type="radio" name="radio1" value="Cash">Cash
                                                        <span class="select"></span>
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="radio1" value="Card">Card
